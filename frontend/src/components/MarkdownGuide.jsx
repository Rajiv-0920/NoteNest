export function MarkdownGuide() {
  return (
    <div class="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 p-6 rounded-xl shadow max-w-3xl mx-auto space-y-4 max-h-[552px] overflow-auto">
      <h2 class="text-xl font-bold">📘 Markdown Quick Guide</h2>

      <div>
        <h3 class="font-semibold text-lg">📌 Headings</h3>
      ...
      <div>
        <h3 class="font-semibold text-lg">✏️ Text Formatting</h3>
      ...
      <div>
        <h3 class="font-semibold text-lg">🖼️ Images</h3>
      ...
      <div>
        <h3 class="font-semibold text-lg">💬 Blockquote</h3>
        <p>For quotes, use:</p>
        <p>
      ...
      <div>
        <h3 class="font-semibold text-lg">📐 Horizontal Rule</h3>
      ...
      <div>
        <h3 class="font-semibold text-lg">🧾 Tables</h3>
